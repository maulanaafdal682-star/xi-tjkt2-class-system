...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if (loginUser($username, $password, 'SISWA')) {
            header('Location: /siswa/');
            exit;
        } else {
...
<head>
    ...
    <title>Login Siswa - XI TJKT 2</title>
    ...
    <div class="login-container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" placeholder="Masukkan username atau NIS" required autofocus>
            </div>
