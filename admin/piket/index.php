...
<head>
    ...
    <title>Manajemen Piket - Admin</title>
    ...
    <style>
        ...
        .avatar { width: 30px; height: 30px; border-radius: 50%; object-fit: cover; margin-right: 8px; }
...
<body>
    <nav class="navbar">
        <div class="navbar-container">
            <div class="navbar-brand">Admin - Jadwal Piket</div>
    ...
    <div class="container">
        <div class="header">
            <h1 style="color: #1e3a8a; margin: 0;">Jadwal Piket</h1>
            ...
            <tbody>
                <?php foreach ($jadwal as $item): ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($item['foto']): ?>
                                <img src="<?= esc($item['foto']) ?>" class="avatar" alt="">
                            <?php endif; ?>
